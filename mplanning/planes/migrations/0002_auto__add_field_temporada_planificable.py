...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Temporada.planificable'
        db.add_column(u'planes_temporada', 'planificable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Temporada.planificable'
        db.delete_column(u'planes_temporada', 'planificable')
