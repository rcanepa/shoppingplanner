...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Itemplandet'
        db.create_table(u'planes_itemplandet', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('periodo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calendarios.Periodo'])),
            ('itemplan', self.gf('django.db.models.fields.related.ForeignKey')(related_name='item_planificacion', to=orm['planes.Itemplan'])),
            ('vta_n', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=15, decimal_places=3, blank=True)),
            ('ctb_n', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=15, decimal_places=3, blank=True)),
            ('dcto', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=15, decimal_places=3, blank=True)),
            ('costo_u', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=15, decimal_places=3, blank=True)),
            ('vta_u', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=15, decimal_places=3, blank=True)),
            ('margen', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=15, decimal_places=3, blank=True)),
        ))
        db.send_create_signal(u'planes', ['Itemplandet'])

        # Deleting field 'Itemplan.contribucion'
        db.delete_column(u'planes_itemplan', 'contribucion')

        # Deleting field 'Itemplan.margen'
        db.delete_column(u'planes_itemplan', 'margen')

        # Deleting field 'Itemplan.venta'
        db.delete_column(u'planes_itemplan', 'venta')


    def backwards(self, orm):
        # Deleting model 'Itemplandet'
        db.delete_table(u'planes_itemplandet')

        # Adding field 'Itemplan.contribucion'
        db.add_column(u'planes_itemplan', 'contribucion',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Itemplan.margen'
        db.add_column(u'planes_itemplan', 'margen',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Itemplan.venta'
        db.add_column(u'planes_itemplan', 'venta',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)
