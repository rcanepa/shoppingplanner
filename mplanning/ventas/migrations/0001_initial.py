...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ventas_venta', (
            ...
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorias.Item'])),
            ('tiempo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calendarios.Tiempo'])),
            ...
            ('costo', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=15, decimal_places=3, blank=True)),
            ('vta_u', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=15, decimal_places=3, blank=True)),
            ('stk_u', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=15, decimal_places=3, blank=True)),
            ('stk_v', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=15, decimal_places=3, blank=True)),
        ))
        db.send_create_signal(u'ventas', ['Venta'])

        # Adding model 'Ventaperiodo'
        db.create_table(u'ventas_ventaperiodo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorias.Item'])),
            ...
            ('tipo', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('vta_n', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=15, decimal_places=3, blank=True)),
            ('ctb_n', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=15, decimal_places=3, blank=True)),
            ('costo', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=15, decimal_places=3, blank=True)),
            ('vta_u', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=15, decimal_places=3, blank=True)),
        ...
        db.send_create_signal(u'ventas', ['Ventaperiodo'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Ventaperiodo'
        db.delete_table(u'ventas_ventaperiodo')
