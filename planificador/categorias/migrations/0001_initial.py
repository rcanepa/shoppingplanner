...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'categorias_categoria', (
            ...
            ('vigencia', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('fecha_creacion', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('categoria_padre', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='categorias_hijos', null=True, to=orm['categorias.Categoria'])),
            ('organizacion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organizaciones.Organizacion'])),
            ('planificable', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'categorias', ['Categoria'])

        # Adding model 'Item'
        db.create_table(u'categorias_item', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('id_real', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=70)),
            ('vigencia', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('item_padre', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='items_hijos', null=True, to=orm['categorias.Item'])),
            ('usuario_responsable', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='items_responsable', null=True, to=orm['auth.User'])),
            ('categoria', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorias.Categoria'])),
            ('temporada', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='items_temporada', null=True, to=orm['planes.Temporada'])),
            ('precio', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal(u'categorias', ['Item'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Item'
        db.delete_table(u'categorias_item')
