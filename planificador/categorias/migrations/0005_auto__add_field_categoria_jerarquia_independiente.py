...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Categoria.jerarquia_independiente'
        db.add_column(u'categorias_categoria', 'jerarquia_independiente',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Categoria.jerarquia_independiente'
        db.delete_column(u'categorias_categoria', 'jerarquia_independiente')
