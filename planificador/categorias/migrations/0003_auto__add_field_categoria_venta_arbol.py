...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Categoria.venta_arbol'
        db.add_column(u'categorias_categoria', 'venta_arbol',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Categoria.venta_arbol'
        db.delete_column(u'categorias_categoria', 'venta_arbol')
