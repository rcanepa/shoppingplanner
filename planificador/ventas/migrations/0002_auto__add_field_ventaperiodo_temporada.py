...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ventaperiodo.temporada'
        db.add_column(u'ventas_ventaperiodo', 'temporada',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['planes.Temporada']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ventaperiodo.temporada'
        db.delete_column(u'ventas_ventaperiodo', 'temporada_id')
