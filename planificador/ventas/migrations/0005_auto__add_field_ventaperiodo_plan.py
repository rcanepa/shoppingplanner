...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ventaperiodo.plan'
        db.add_column(u'ventas_ventaperiodo', 'plan',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['planes.Plan'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ventaperiodo.plan'
        db.delete_column(u'ventas_ventaperiodo', 'plan_id')
    ...
    models = {
        ...
        u'calendarios.tiempo': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'periodo': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'tiempos_incluidos'", 'symmetrical': 'False', 'to': u"orm['calendarios.Periodo']"}),
