...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ventaperiodo.precio_real'
        db.add_column(u'ventas_ventaperiodo', 'precio_real',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=15, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'Ventaperiodo.costo_unitario'
        db.add_column(u'ventas_ventaperiodo', 'costo_unitario',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=15, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'Ventaperiodo.dcto'
        db.add_column(u'ventas_ventaperiodo', 'dcto',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=15, decimal_places=3, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ventaperiodo.precio_real'
        db.delete_column(u'ventas_ventaperiodo', 'precio_real')

        # Deleting field 'Ventaperiodo.costo_unitario'
        db.delete_column(u'ventas_ventaperiodo', 'costo_unitario')

        # Deleting field 'Ventaperiodo.dcto'
        db.delete_column(u'ventas_ventaperiodo', 'dcto')
    ...
    models = {
        ...
        u'ventas.ventaperiodo': {
            ...
            'anio': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'costo': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '15', 'decimal_places': '3', 'blank': 'True'}),
            'costo_unitario': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '15', 'decimal_places': '3', 'blank': 'True'}),
            'ctb_n': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '15', 'decimal_places': '3', 'blank': 'True'}),
            'dcto': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '15', 'decimal_places': '3', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'venta_item'", 'to': u"orm['categorias.Item']"}),
            ...
            'plan': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['planes.Plan']", 'null': 'True'}),
            'precio_real': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '15', 'decimal_places': '3', 'blank': 'True'}),
            'stk_u': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '15', 'decimal_places': '3', 'blank': 'True'}),
            'stk_v': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '15', 'decimal_places': '3', 'blank': 'True'}),
            'temporada': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['planes.Temporada']"}),
