...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Controlventa'
        db.create_table(u'ventas_controlventa', (
        ...
        db.send_create_signal(u'ventas', ['Controlventa'])


    def backwards(self, orm):
        # Deleting model 'Controlventa'
        db.delete_table(u'ventas_controlventa')
