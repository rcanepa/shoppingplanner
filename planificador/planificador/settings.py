...
DATABASES = {
    'default': {
        ...
        'NAME': 'plandb',                      # Or path to database file if using sqlite3.
...
STATICFILES_DIRS = (
    ...
    os.path.join(TEMP_PATH, 'planes/static')
...
SECRET_KEY = 'pywwp!x&0v189(+6)^$n8d1%7)$u@2gpvze2o4yghqc69afmo*'
...
MIDDLEWARE_CLASSES = (
    ...
    'planificador.middleware.AutoLogout', # For the auto logout
)
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    #'/home/rcanepa/Development/planificador/mplanning/templates'
