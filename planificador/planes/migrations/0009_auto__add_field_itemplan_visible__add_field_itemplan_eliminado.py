...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Itemplan.visible'
        db.add_column(u'planes_itemplan', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Itemplan.eliminado'
        db.add_column(u'planes_itemplan', 'eliminado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Itemplan.visible'
        db.delete_column(u'planes_itemplan', 'visible')

        # Deleting field 'Itemplan.eliminado'
        db.delete_column(u'planes_itemplan', 'eliminado')
    ...
    models = {
        ...
        u'categorias.categoria': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jerarquia_independiente': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
